        ...
        <div className="w-full">
          ...
          <div className="w-full">
            ...
            {message.isToolUse && !['Read', 'TodoWrite', 'TodoRead'].includes(message.toolName) ? (
              ...
              <details className="text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-200 dark:border-red-800 relative">
                <summary className="cursor-pointer font-medium hover:text-red-800 dark:hover:text-red-200 flex items-center gap-2 outline-none select-none">
                  <svg className="w-4 h-4 transition-transform details-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                  Error Detail{mcpContext || ''}
                </summary>
                <div className="mt-3 relative">
                  ...
                  <div className="whitespace-pre-wrap select-all cursor-text pr-16 bg-white dark:bg-gray-900/50 p-3 rounded border border-red-100 dark:border-red-900/50 overflow-x-auto text-xs font-mono">
                    {message.content}
                  </div>
                </div>
              </details>
